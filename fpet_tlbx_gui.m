...
uimenu(fileMenu, 'Text', 'New Batch', 'MenuSelectedFcn',  @(src, event) newBatchWrapper(src, event));
uimenu(fileMenu, 'Text', 'Open Batch', 'MenuSelectedFcn', @(src, event) openBatchWrapper(src, event));
